            ...
            <div className="pt-32 pb-20 px-4 md:px-8 max-w-7xl mx-auto">
                ...
                {isLoading ? (
                    <div className="flex flex-col items-center justify-center py-24">
                        ...
                        <p className="text-gray-500 font-medium font-outfit">Loading your appointments...</p>
                    </div>
                ) : (
                                    ...
                                    <div className="flex flex-col md:flex-row gap-6 md:items-center">
                                        ...
                                        <div className="flex items-center justify-between md:justify-end gap-4 w-full md:w-auto">
                                            ...
                                            {user?.role === "patient" && app.status === "completed" && (
                                                <button className="flex items-center gap-2 px-4 py-2 bg-amber-500 text-white rounded-xl font-bold text-sm hover:bg-amber-600 transition-all shadow-lg shadow-amber-500/20">
